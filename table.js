$(document).ready(function () {
   ...
   let sum = 1;
    $("#addrow").on("click", function () {
        ...
        cols += '<td type="col"><select type="text" class="export Message custom-select" name="Message" style="width:110"><option value=11>Przelew przychodz±cy</option>'+
                    '<option value=11>Uznanie czekiem rozliczeniowym</option><option value=11>Wp³ata gotówkowa zwyk³a</option><option value=11>Wp³ata gotówkowa US</option>'+
                    '<option value=11>Przelew przychodz±cy SORBNET</option>'+
                    '<option value=19>Zwrot przelewu</option><option value=19>Zwrot uznania czekiem rozliczeniowym</option><option value=19>Zwrot wp³aty gotówkowej zwyk³ej</option>'+
                    '<option value=19>Zwrot wp³aty gotówkowej US</option>'+
                    '<option value=21>Polecenie zap³aty</option><option value=22>Obci±¿enie czekiem gotówkowym</option><option value=22>Obci±¿enie czekiem rozliczeniowym</option>'+
